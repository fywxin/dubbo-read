...
public class RegistryDirectory<T> extends AbstractDirectory<T> implements NotifyListener {
    ...
    private final String[] serviceMethods; /// 构造时初始化

    private final boolean multiGroup; /// 构造时初始化
  ...
  ///黑白名单相关
    ...
    ///notify(List<URL> urls) 时赋值
    ///将URL映射Invoker 调用 RegistryProtocol.refer(Class type, String url)
    ...
    // Set<invokerUrls> cache invokeUrls to invokers mapping.  缓存invokerUrls列表，便于交叉对比
     ...
     * 1.合并URL参数
     * 2.以URL为key从volatile Map<String, Invoker<T>> urlInvokerMap 查找Invoker
     * 3.缓存中没有，重新refer 生成Invoker 并缓存
     * 4.返回 Map<String, Invoker<T>> newUrlInvokerMap
     * @param urls
     * @param overrides
     * @param query
     * @return invokers
    ...
    public List<Invoker<T>> doList(Invocation invocation) {
        ...
        //see @refreshInvoker(List<URL> invokerUrls)
