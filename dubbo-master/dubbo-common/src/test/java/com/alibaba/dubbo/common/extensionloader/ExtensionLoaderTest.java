...
import com.alibaba.dubbo.common.extensionloader.ext6_wrap.impl.Ext5Impl1;
...
public class ExtensionLoaderTest {
	 ...
	 @Test
	    public void test_getExtension_WithWrapper() throws Exception {
	        ...
	        ///assertTrue(impl1 instanceof Ext5Wrapper1);
	        ///assertTrue(impl1 instanceof Ext5Wrapper2);
	        assertThat(impl1, anyOf(instanceOf(Ext5Wrapper1.class), instanceOf(Ext5Wrapper2.class)));
	        
	        WrappedExt impl2 = ExtensionLoader.getExtensionLoader(WrappedExt.class).getExtension("impl2") ;
	        assertThat(impl2, anyOf(instanceOf(Ext5Wrapper1.class), instanceOf(Ext5Wrapper2.class)));
	       /// assertTrue(impl2 instanceof Ext5Wrapper1);
	      ///  assertTrue(impl2 instanceof Ext5Wrapper2);
	 ...
	 @Test
	    public void test_hasExtension_wrapperIsNotExt() throws Exception {
	        ...
	        ///assertTrue(ExtensionLoader.getExtensionLoader(WrappedExt.class).hasExtension("impl2"));
	        ///assertTrue(ExtensionLoader.getExtensionLoader(WrappedExt.class).hasExtension("wrapper2"));
	    ...
	    public void test_AddExtension_Adaptive_ExceptionWhenExistedAdaptive() throws Exception {
	        ...
	        Set<String> names1 = loader.getLoadedExtensions();
	        Set<String> names2 = loader.getSupportedExtensions();
	        
	        AddExt1 default1 = loader.getDefaultExtension();
	        default1.whoAmI();
	        
//	        AddExt1 what = loader.getAdaptiveExtension();
//	        ///Assert.assertNull(what);
//	        what.whoAmI();
	 ...
	 @Test
	    public void test_replaceExtension_Adaptive_ExceptionWhenNotExistedExtension() throws Exception {
	        ...
	        ExtensionLoader<AddExt3> loader3 = ExtensionLoader.getExtensionLoader(AddExt3.class);

	        try {
	            loader3.replaceExtension(null, AddExt3_ManualAdaptive.class);
	            fail();
	        }
	        catch (IllegalStateException expected) {
	            assertThat(expected.getMessage(), containsString("Adaptive Extension not existed(Extension interface com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt3)"));
	        }
	    }
	 //-----------------------------------------------------------------------------------------------------------------------------------
